...
// once again, chloe collection types, they'll mismatch with the vanilla game after racing
enum eTrackType {
	TRACKTYPE_FOREST = 1,
	TRACKTYPE_FIELDS = 2,
	TRACKTYPE_DESERT = 3,
	...
	TRACKTYPE_CITY = 5,
	TRACKTYPE_RACING = 6,
	TRACKTYPE_FO1_TOWN = 7,
	TRACKTYPE_FO1_PIT = 8,
	TRACKTYPE_FO1_WINTER = 9,
	TRACKTYPE_TOUGHTRUCKS = 10,
	TRACKTYPE_RALLYTROPHY = 11,
	TRACKTYPE_RALLYTROPHYARCADE = 12,
	TRACKTYPE_EVENT = 13,
	TRACKTYPE_STUNT = 14,
	TRACKTYPE_DERBY = 15,
	TRACKTYPE_REVERSED = 16,
	TRACKTYPE_ARCADERACE = 17,
	TRACKTYPE_BEATTHEBOMB = 18,
	TRACKTYPE_TONYHAWK = 19,
	TRACKTYPE_SPEEDTRAP = 20,
	TRACKTYPE_GARAGETEST = 21,
	NUM_TRACKTYPES
};